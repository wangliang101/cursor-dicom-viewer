...
const ViewerContainer = forwardRef(({ images, currentImageIndex }, ref) => {
  return (
    <div className={styles.viewerWrapper}>
      <Card className={styles.viewerCard} bodyStyle={{ padding: 0 }}>
                ...
                <div className={styles.placeholderIcon}>
                  <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
                    ...
                    <path
                      ...
                      strokeLinecap="round"
                    />
                    <circle cx="32" cy="32" r="12" stroke="#6b7c93" strokeWidth="1.5" fill="none" />
                  </svg>
                </div>
